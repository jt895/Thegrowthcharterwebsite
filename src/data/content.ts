/**
 * Site-wide copy for The United Republic.
 *
 * All headlines, body copy and labelled text live here, separated from
 * component/layout logic. Components import the relevant object and
 * render its fields — no literal copy should live inline in a page or
 * component file.
 */
...
export interface NavLink<TPage extends string = string> {
  label: string;
  page: TPage;
}
...
export const siteContent = {
  brandName: "The United Republic",
  brandNameLines: ["The United", "Republic"],
  tagline: "Strategy, growth and practical implementation",
  blurb:
  ...
  copyright: "© 2026 The United Republic. All rights reserved.",
  contact: {
    email: "jt@theunitedrepublic.com.au",
    phone: "+61 407 744 388",
    phoneHref: "tel:+61407744388",
  },
};
...
export const navContent = {
  growthCharter: "The Growth Charter",
  ...
  mobileLinks: [
    ...
    { label: "Strategic Advisory", page: "strategic-advisory" },
    { label: "Services", page: "services" },
    { label: "The Growth Charter", page: "growth-charter" },
...
export const footerContent = {
  navHeading: "Ways to work with us",
  navLinks: [
    { label: "Strategic Advisory", page: "about" },
    { label: "The Growth Charter", page: "growth-charter" },
    { label: "How We Work", page: "how-we-work" },
    { label: "Services", page: "services" },
  ] as NavLink[],
  contactHeading: "Contact",
  enquiryLabels: ["Growth Charter enquiry", "Strategic Advisory enquiry"],
};
...
export const homeContent = {
  hero: {
    ...
    title: "Business growth needs sharper choices, not more activity.",
    subA:
  ...
  problem: {
    eyebrow: "The Problem",
    title: "You need growth, you don't need more marketing.",
    titleLine2: "Good businesses plateau when the next decision is unclear.",
    body:
  ...
  choosePath: {
    ...
    title: "One advisory practice. Two clear ways to engage.",
    subtitle: "Start with the path that matches the decision you need to make.",
    advisory: {
      eyebrow: "Government, corporate and complex organisations",
    ...
    growthCharter: {
      eyebrow: "Australian start-ups & established businesses",
      title: "The Growth Charter",
      body:
      ...
      cta: "Explore The Growth Charter",
    },
  },
  whyTur: {
    eyebrow: "Why The United Republic",
    title: "Senior strategic thinking, scaled for practical business growth.",
    body:
    ...
    pillars: [
      {
        ...
        body:
          "We connect customer, brand, sales, margin and capacity decisions so growth is tied to business value, not activity.",
      },
      {
        title: "Evidence led",
        body:
          "We test owner belief against customer insight, business data and market reality before choosing priorities.",
      },
      {
        title: "Built to implement",
        body:
          "The output is a staged plan with owners, measures, tools and decisions your team can keep using.",
      },
      {
        title: "Capability not Dependency",
        body:
          "You own what we build and know how to use it. Our job is to make ourselves unnecessary, not indispensable. But we're always here when you need support or advice.",
      },
    ] as TitleBody[],
  },
  results: {
    eyebrow: "Results",
    title: "Evidence of growth, not just intent.",
    body:
    ...
    stat: {
      value: "25+",
      label: "years of building brands, targeting the right customers, growing businesses and improving capability.",
    },
  },
  clientLogos: {
    label: "Experience behind the thinking — We've worked with Australia's Favourite Brands:",
  },
  cta: {
    title: "Find the growth decision your business needs next.",
    body:
    ...
    ctaPrimary: "Book a discovery session",
    ctaSecondary: "Review the program",
  },
};
    ...
    items: [
      {
        ...
        body:
          "If we don't understand your business and your objectives we can't find the right levers to pull, or the barriers holding you back, or know what success looks like.",
      },
      {
        title: "Customers and Audience First",
        body:
          "By understanding your customers and your audiences, we know what problem you're solving for them and why they buy, and where the opportunities for growth lie.",
      },
      {
...
export const growthCharterContent = {
  hero: {
    eyebrow: "The United Republic",
    title: "Your business is working. The next stage needs a clearer plan.",
    paraA:
    ...
    ctaPrimary: "Book a Growth Charter conversation",
    ctaSecondary: "See how it works",
  },
  whatIs: {
    eyebrow: "The program",
    title: "What is The Growth Charter?",
    paraA:
    ...
    pillars: [
      {
        ...
        body: "We test owner belief against customer insight, commercial data and market reality before any decisions are made.",
      },
      {
        title: "Strategy before execution",
        body: "No campaigns, websites or marketing spend until the commercial direction is clear and the priorities are set.",
      },
      {
        title: "Built for your business",
        body:
          "The program is tailored to your stage, your sector and your goals — not a generic framework applied the same way to every client.",
      },
      {
        title: "Capability, not dependency",
        body: "You own everything we build together. Our job is to make you more capable, not to keep you reliant on us.",
      },
    ] as TitleBody[],
  },
  waysToWork: {
    eyebrow: "Ways to work together",
    title: "The same method, with the level of support you need.",
    modes: [
      {
        title: "Business Launch Essentials",
        sub:
          "For new, newly established or small businesses that need the right commercial, brand and digital foundations from the start, including positioning, messaging and a launch-ready website.",
        note: "A focused path for new ventures and small businesses wanting to grow",
      },
      {
        title: "DIY",
        sub:
        ...
        note: "Online program in development",
      },
      {
        ...
        note: "Best for hands-on owners and capable internal teams",
      },
      {
        title: "Done For You",
        sub:
          "We conduct the research, analysis and strategic work, build the plan and support implementation with the right specialists where required.",
        note: "Best for speed, complexity or limited internal capacity",
      },
    ] as EngagementMode[],
  },
  plateau: {
    title: "Why good businesses plateau",
    body:
  ...
  centralIdea: {
    ...
    title: "What you believe. What the evidence says.",
    paraA:
  ...
  howItWorks: {
    ...
    title: "Five stages. One commercial plan.",
    body:
    ...
    stages: [
      {
        ...
        body:
          "We capture how you and your team see the business today, including your goals, customers, commercial model, capacity, risks and personal endgame.",
      },
      {
        num: "02",
        ...
        body:
          "We test those beliefs against customer research, commercial data and market reality, then size and rank the opportunities in dollars, effort and time to impact.",
      },
      {
        num: "03",
        section: "A clearer place in the market",
        title: "Branding & Positioning",
        body:
          "We define what you are really selling, why the right customers should choose you and how your business can stand apart in a way you can deliver.",
      },
      {
        num: "04",
        section: "Who matters and how to reach them",
        title: "Audiences, Messaging & Channel Planning",
        body:
          "We set customer priorities, shape the messages that matter and choose the channels that fit how people actually make decisions.",
      },
      {
        num: "05",
        section: "Turn the plan into action",
        title: "Go To Market & Implementation",
        body:
          "We create a staged plan with responsibilities, timing, budgets, measures and the practical tools your team needs to deliver it.",
      },
    ] as GrowthStage[],
  },
  whatYouLeaveWith: {
    eyebrow: "What you leave with",
    title: "A clear commercial direction and the practical means to act on it.",
    points: [
  ...
  whyTur: {
    eyebrow: "Why The United Republic",
    title: "Big business experience, applied to your business.",
    paraA:
  ...
  fitCheck: {
    title: "Is The Growth Charter right for your business?",
    body:
    ...
    cta: "Book a Growth Charter conversation",
    points: [
  ...
  phases: [
    {
      num: "01",
      title: "Diagnose",
      tagline: "We identify the problem behind the brief",
      body:
        "Before any strategy work begins, we need to understand what's really going on. This phase combines audience research, stakeholder insight, communications audits and strategic analysis to define the real challenge—not just the symptoms.",
      delivers: [
      ...
      approach:
        "We can support this phase as a standalone diagnostic, or as the foundation for ongoing strategy and delivery work. The diagnostic output becomes the brief for everything that follows.",
    },
    {
      num: "02",
      title: "Design",
      tagline: "We turn complexity into a clear plan",
      body:
        "Once the problem is clear, we build the strategy. This means creating frameworks, plans and direction that guide decision-making, shape creative development, and ensure all activity is aligned to outcomes.",
      delivers: [
      ...
      approach:
        "Strategy work can be delivered as a complete plan, or we can work alongside internal teams to co-create and build capability. Every strategy is designed to survive contact with reality.",
    },
    {
      num: "03",
      title: "Direct",
      tagline: "We help the strategy survive contact with reality",
      body:
        "Strategy only works if it's executed well. We help clients identify and brief the right agency and specialist partners, provide strategic oversight during implementation, and ensure the work stays true to the original intent.",
      delivers: [
      ...
      approach:
        "This is where the tailored team model comes to life. We identify, brief and guide specialist partners—whether that's creative agencies, media partners, content producers, or delivery teams—to bring the strategy to life with the right expertise.",
    },
    {
      num: "04",
      title: "Measure",
      tagline: "We help clients understand what worked and what to do next",
      body:
        "Measuring outcomes is how we learn. We help clients evaluate campaign performance, test messages, review what worked, and plan refinements based on evidence.",
      delivers: [
      ...
      approach:
        "Evaluation feeds back into strategy. We help clients build a cycle of learning that improves performance over time and ensures future work is smarter, sharper and more focused.",
    },
  ] as WorkPhase[],
  cta: {
    eyebrow: "Strategy through to delivery",
    title:
...
export const servicesContent = {
  ...
  services: [
    {
      ...
      sub: "Senior marketing leadership without the full-time overhead",
      duration: "Ongoing / retainer",
      body:
        "Access experienced, senior marketing leadership on a fractional basis — embedded in your business to own the strategy, lead the team and drive commercial outcomes without the cost of a full-time executive hire.",
      included: [
        "Marketing strategy ownership and accountability",
        "Brand positioning and messaging direction",
        "Team leadership and capability development",
        "Agency and partner management",
        "Budget planning and channel allocation",
        "Performance reporting and optimisation",
        "Board and executive-level reporting",
      ],
      when:
        "Use this when you need senior marketing leadership but aren't ready or resourced for a full-time CMO. Ideal for growth-stage businesses, organisations in transition, or teams that need experienced direction.",
      execution:
        "Operates as part of your leadership team. Typically engaged on a monthly retainer with defined scope, regular reviews and clear performance measures.",
    },
    {
      id: "strategy-workshops",
      title: "Strategy Workshops",
      sub: "Focused sessions to align thinking and unlock direction",
      duration: "Half-day to 2 days",
      body:
        "Facilitated strategy sessions designed to align your team, clarify the challenge, define priorities and build shared direction — fast. Each workshop is designed around your specific need, from problem definition to planning.",
      included: [
        "Pre-workshop discovery and preparation",
        "Facilitated problem definition session",
        "Audience and market insight review",
        "Priority-setting and decision frameworks",
        "Strategic direction and next steps",
        "Workshop summary and action plan",
      ],
      when:
        "Use this when your team needs to get aligned quickly, when you're at a strategic crossroads, or when you need structured thinking to unblock a decision.",
      execution:
        "Can be delivered as a standalone session or as the first phase of a broader strategy engagement. Remote or in-person.",
    },
    {
      id: "strategic-diagnostic",
      title: "Strategic Diagnostic",
      sub: "Define the real problem before you invest",
      duration: "2–4 weeks",
      body:
        "A focused diagnostic to understand the challenge, map the landscape, and define where strategic focus will have the greatest impact.",
      included: [
      ...
      when:
        "Use this when you need clarity on the problem before committing to strategy or execution. Ideal for organisations that want to make sure they're solving the right challenge.",
    ...
    },
    {
      ...
      sub: "Create the plan that guides everything",
      duration: "6–12 weeks",
      body:
        "A complete communications or campaign strategy—from problem definition through to delivery frameworks, partner briefing and implementation guidance.",
      included: [
      ...
      when:
        "Use this when you have a clear challenge and need a comprehensive strategy to guide execution. Includes identification of delivery partners and briefing support.",
      execution:
        "Includes agency/partner identification and briefing. Can be delivered as a handover, or we can provide ongoing strategic oversight during implementation.",
    },
    {
      id: "strategic-lead",
      title: "Strategic Lead",
      sub: "Ongoing strategic guidance from problem to delivery",
      duration: "3–12 months (or longer)",
      body:
        "Embedded strategic leadership across the full project lifecycle—from initial problem definition through strategy development, partner briefing, and implementation oversight.",
      included: [
      ...
      execution:
        "Full integration with your team and delivery partners. We identify, brief and guide specialist agencies and partners throughout, ensuring strategy is carried through to execution.",
    },
    {
      id: "review-refine",
      title: "Review and Refine",
      sub: "Evaluate what worked and improve what's next",
      duration: "2–4 weeks",
      body:
        "Post-campaign evaluation, performance analysis and strategic refinement to learn from what worked and plan smarter next steps.",
      included: [
  ...
  cta: {
    ...
    title: "Every project is different. We can tailor our approach to suit your challenge, your timeline, and where you need support most.",
    body: "Let's talk about what you're trying to achieve.",
    ctaLabel: "Book an initial conversation",
    quote:
...
export const strategicAdvisoryContent = {
  hero: {
    ...
    title: "Start with the right questions, then build the right response.",
    paraA: "The United Republic helps organisations define the real problem, shape the right strategy, and guide the work that follows.",
    paraB:
    ...
    ctaPrimary: "Start with a strategic diagnostic",
  ...
  whyEngageEarly: {
    eyebrow: "Approach",
    title: "Why clients engage us early",
    reasons: [
  ...
  methodology: {
    ...
    title: "The United Republic Creative Methodology",
    steps: [
      {
        num: "01",
        title: "Start with the foundation, not the finish",
        body:
          "Brilliant work begins with the basics. We start by understanding audiences deeply, identifying the true challenge, quantifying what matters most, and mapping the barriers, segments and behaviours that will shape success. Strategy comes first, and everything else follows from that.",
        items: [
      ...
      },
      {
        ...
        body:
          "We do not run a fixed creative department or force work through an agency machine. We build the right team around each challenge, bringing together the best senior specialists for the job. That keeps the work tailored, lean and focused on outcomes.",
        items: [
  ...
  builtFor: {
    ...
    highStakesTitle: "Experience across high-stakes work",
    highStakes: [
